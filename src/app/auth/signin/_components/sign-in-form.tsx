          ...
          <div className="flex flex-col gap-3">
            {oauthProviders.google && (
              <button
                ...
                className="flex items-center justify-center gap-3 rounded-lg bg-white/10 px-4 py-3 font-medium transition hover:bg-white/20 active:bg-white/30 min-h-[44px]"
              >
