// Placeholder page for the Bank feature. Auth-protected and linked from the Hub.
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto max-w-5xl p-4 md:p-8">
        ...
        <h1 className="text-2xl font-bold text-cyan-400">Bank</h1>
        <p className="mt-2 text-slate-400">
          Manage your finances and store items
        </p>
